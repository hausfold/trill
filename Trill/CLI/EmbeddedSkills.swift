// Generated by scripts/generate-skills.sh — do not edit.
//
// The source is ai/**/SKILL.md. Edit those, run the script, commit both:
// scripts/check-skills.sh fails the build when this file and the Markdown
// disagree, because a binary whose `skill` verb prints last week's prose is
// worse than one that prints none — nobody can tell which they got.

extension TrillCLI {
    /// Every skill this build ships, in the layout the standard fixes:
    /// `ai/SKILL.md` is the tool's own, named for the tool, and each
    /// `ai/<name>/SKILL.md` beside it is named for its directory.
    enum EmbeddedSkills {
        static let all: [EmbeddedSkill] = [
            EmbeddedSkill(name: "trill", body: #"""
---
name: trill
